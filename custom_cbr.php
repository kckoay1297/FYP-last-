        ...
        public function __construct($date1, $date2, $budget1, $budget2, $department1, $department2, $level1, $level2,$aIncome1, $aIncome2, $feedback1, $feedback2, $cSize1, $cSize2,$aPpt1, $aPpt2, $weight,$expenses1,$expenses2,$desc1,$desc2) {
			 ...
			 $this->$desc2 = $desc2;
                 ...
                 public function calculateSim($date1, $date2, $budget1, $budget2, $level1, $level2,$aIncome1, $aIncome2, $feedback1, $feedback2, $cSize1, $cSize2,$aPpt1, $aPpt2,$weight,$expenses1,$expenses2,$desc1,$desc2){
					 ...
					 //echo $wdate ."<br>".$wbudget ."<br>".$
					 $sum = $wdate + $wbudget + $wlevel + $wincome + $wfeedback + $wcSize + $wppt + $wexpenses + $wdesc;
					// echo $sum;
				 ...
				 public function sentence_similarity($new,$old){
					 ...
					 include_once 'nlp_process.php';
					 include_once 'string_similarity.php';
					 $new1 = nlp($new);
					 $old1 = nlp($old);
					// echo $old1."<br>".$new1."<br>";
					/* if(strlen($new1) >= strlen($old)){
						//return 1 - ((levenshtein($new1,$old,1,1,0)/strlen($new1)) *1) ;
						similar_text($new1,$old1,$percent);
						return $percent/100 ;

					}else{
						//return 1 - ((levenshtein($new1,$old,1,1,0)/strlen($old1))*1);
						similar_text($new1,$old1,$percent);
						return $percent/100 ;
					}*/
					    include_once 'sem_similarity.php';
						//echo "<br>New:".$new1."<br>Old:".$old1."<br>";
						return similarity($new1,$old1);
					//echo string_compare($old1,$new1)."<br>";
					//return string_compare($old1,$new1);
				 }
